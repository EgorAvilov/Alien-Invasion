...
Информация о погоде берется из Weather.com.
...
Предоставить пользователю интересующую его информацию по городам.
  ...
  При взаимодействии с ботом пользователю необходимо отправить сообщение с интересующим его городом. Если такой город существует, то пользователь получит по нему информацию. В противном случае сообщение об отсутствии запрашиваемого 
 
### 5. Аналоги <a name="5"></a>
Wikiway - информация о городах.
